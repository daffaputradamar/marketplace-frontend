...
import SaldoSaya from './SaldoSaya'
      ...
      {doesHaveSameUsahaId() && (
        <Grid columns={2} style={styles.marginGrid}>
          ...
          <Grid.Column width="13">
            {activeItem === listActiveItem.pesananSaya && (
              <PesananSayaUsaha history={props.history} />
            )}
            ...
            {activeItem === listActiveItem.saldoSaya && (
              <SaldoSaya usaha={usaha} />
            )}
          </Grid.Column>
        </Grid>
      )}
